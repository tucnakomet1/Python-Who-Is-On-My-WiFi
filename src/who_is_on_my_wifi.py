...
def device():
    ...
    if plat == "Darwin":
        ...
        try:
            ...
            DNS1 = DNS1.decode("utf-8").split()
        except:
            DNS1 = "unknown"

        try:
            #DNS2 = "unknown"
            DNS2 = subprocess.Popen("networksetup -getdnsservers airport", shell=True, stdout=subprocess.PIPE)
            DNS2 = DNS2.stdout.readline()
            DNS2 = DNS2.decode("utf-8").split()
        except:
            DNS2 = "unknown"
        ...
        try:
            ...
            if SSID == "unknown":
                ...
                password = password.decode("utf-8").split()
        except:
            password = "unknown"
